--- src/VBox/Devices/Graphics/DevVGA-SVGA3d-ogl.cpp.orig	2020-05-14 18:23:58 UTC
+++ src/VBox/Devices/Graphics/DevVGA-SVGA3d-ogl.cpp
@@ -1183,7 +1183,7 @@ int vmsvga3dTerminate(PVGASTATE pThis)
...
@@ -3184,7 +3184,7 @@ int vmsvga3dGenerateMipmaps(PVGASTATE pThis, uint32_t 
 }
...
+#if defined(RT_OS_FREEBSD) || defined(RT_OS_LINUX)
  ...
  *
@@ -3214,7 +3214,7 @@ DECLCALLBACK(int) vmsvga3dXEventThread(RTTHREAD hThrea
     }
     return VINF_SUCCESS;
 }
-#endif // RT_OS_LINUX
+#endif // RT_OS_FREEBSD || RT_OS_LINUX
 ...
 /**
@@ -3549,7 +3549,7 @@ static int vmsvga3dContextDestroyOgl(PVGASTATE pThis, 
     AssertRC(rc);
 #elif defined(RT_OS_DARWIN)

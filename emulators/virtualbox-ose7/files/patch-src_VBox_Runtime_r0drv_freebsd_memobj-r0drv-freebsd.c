--- src/VBox/Runtime/r0drv/freebsd/memobj-r0drv-freebsd.c.orig	2024-10-10 18:32:15 UTC
...
@@ -220,6 +220,7 @@ DECLHIDDEN(int) rtR0MemObjNativeFree(RTR0MEMOBJ pMem)
...
@@ -329,7 +330,8 @@ static int rtR0MemObjFreeBSDAllocHelper(PRTR0MEMOBJFRE
...
@@ -371,6 +373,7 @@ DECLHIDDEN(int) rtR0MemObjNativeAllocPage(PPRTR0MEMOBJ
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     PRTR0MEMOBJFREEBSD pMemFreeBSD = (PRTR0MEMOBJFREEBSD)rtR0MemObjNew(sizeof(*pMemFreeBSD), RTR0MEMOBJTYPE_PAGE,
                                                                        NULL, cb, pszTag);
     if (pMemFreeBSD)
@@ -380,8 +383,10 @@ DECLHIDDEN(int) rtR0MemObjNativeAllocPage(PPRTR0MEMOBJ
...
@@ -395,6 +400,7 @@ DECLHIDDEN(int) rtR0MemObjNativeAllocLow(PPRTR0MEMOBJI
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     ...
     if (pMemFreeBSD)
     {
@@ -403,14 +409,17 @@ DECLHIDDEN(int) rtR0MemObjNativeAllocLow(PPRTR0MEMOBJI
             *ppMem = &pMemFreeBSD->Core;
         else
             rtR0MemObjDelete(&pMemFreeBSD->Core);
+        IPRT_FREEBSD_RESTORE_EFL_AC();
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     PRTR0MEMOBJFREEBSD pMemFreeBSD = (PRTR0MEMOBJFREEBSD)rtR0MemObjNew(sizeof(*pMemFreeBSD), RTR0MEMOBJTYPE_CONT,
                                                                        NULL, cb, pszTag);
     if (pMemFreeBSD)
@@ -423,8 +432,10 @@ DECLHIDDEN(int) rtR0MemObjNativeAllocCont(PPRTR0MEMOBJ
         }
         else
             rtR0MemObjDelete(&pMemFreeBSD->Core);
+        IPRT_FREEBSD_RESTORE_EFL_AC();
...
@@ -432,6 +443,7 @@ static int rtR0MemObjFreeBSDAllocPhysPages(PPRTR0MEMOB
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     ...
     if (pMemFreeBSD)
@@ -439,7 +451,8 @@ static int rtR0MemObjFreeBSDAllocPhysPages(PPRTR0MEMOB
...
@@ -462,8 +475,10 @@ static int rtR0MemObjFreeBSDAllocPhysPages(PPRTR0MEMOB
...
@@ -486,6 +501,7 @@ DECLHIDDEN(int) rtR0MemObjNativeEnterPhys(PPRTR0MEMOBJ
                                           const char *pszTag)
 {
...
@@ -497,8 +513,10 @@ DECLHIDDEN(int) rtR0MemObjNativeEnterPhys(PPRTR0MEMOBJ
...
@@ -510,6 +528,7 @@ static int rtR0MemObjNativeLockInMap(PPRTR0MEMOBJINTER
...
@@ -519,21 +538,28 @@ static int rtR0MemObjNativeLockInMap(PPRTR0MEMOBJINTER
     if (!pMemFreeBSD)
         return VERR_NO_MEMORY;
...
@@ -573,6 +599,7 @@ static int rtR0MemObjNativeReserveInMap(PPRTR0MEMOBJIN
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     ...
     /*
@@ -631,11 +658,13 @@ static int rtR0MemObjNativeReserveInMap(PPRTR0MEMOBJIN
...
@@ -659,6 +688,8 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
...
@@ -713,6 +744,7 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
...
@@ -721,6 +753,7 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
     else
...
@@ -728,6 +761,8 @@ DECLHIDDEN(int) rtR0MemObjNativeMapUser(PPRTR0MEMOBJIN
...
+
      ...
      */
@@ -785,44 +820,50 @@ DECLHIDDEN(int) rtR0MemObjNativeMapUser(PPRTR0MEMOBJIN
...
@@ -833,7 +874,12 @@ DECLHIDDEN(int) rtR0MemObjNativeProtect(PRTR0MEMOBJINT
...
@@ -858,11 +904,19 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
...
@@ -871,11 +925,15 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
...
@@ -886,9 +944,11 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
         {
             RTHCPHYS addr;

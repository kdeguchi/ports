--- src/VBox/HostDrivers/Support/freebsd/SUPDrv-freebsd.c.orig	2024-10-10 18:31:27 UTC
...
+#include <iprt/param.h> /* for PAGE_OFFSET_MASK */
+ 
...
+DECLARE_MODULE_WITH_MAXVER(vboxdrv,     g_VBoxDrvFreeBSDModule, SI_SUB_PSEUDO, SI_ORDER_ANY, KERNEL_RELBRANCHEND);
 ...
 /**
@@ -183,6 +198,13 @@ static int VBoxDrvFreeBSDLoad(void)
...
+
              ...
              */
@@ -322,7 +344,45 @@ static int VBoxDrvFreeBSDIOCtl(struct cdev *pDev, u_lo
...
+
  ...
  *
@@ -372,11 +432,10 @@ static int VBoxDrvFreeBSDIOCtlSlow(PSUPDRVSESSION pSes
          */
         SUPREQHDR Hdr;
         pvUser = *(void **)pvData;
...
+            return EFAULT;           
         ...
         {
@@ -401,13 +460,12 @@ static int VBoxDrvFreeBSDIOCtlSlow(PSUPDRVSESSION pSes
...
@@ -435,9 +493,8 @@ static int VBoxDrvFreeBSDIOCtlSlow(PSUPDRVSESSION pSes
...
@@ -540,8 +597,7 @@ bool VBOXCALL  supdrvOSAreCpusOfflinedOnSuspend(void)
...
@@ -637,6 +693,19 @@ int VBOXCALL    supdrvOSMsrProberModify(RTCPUID idCpu,
...
+
 ...
 {
@@ -651,17 +720,28 @@ SUPR0DECL(int) SUPR0PrintfV(const char *pszFormat, va_

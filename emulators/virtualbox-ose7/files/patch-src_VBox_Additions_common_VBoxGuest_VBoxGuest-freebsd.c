--- src/VBox/Additions/common/VBoxGuest/VBoxGuest-freebsd.c.orig	2024-10-10 18:23:33 UTC
...
@@ -272,14 +211,14 @@ static int vgdrvFreeBSDOpen(struct cdev *pDev, int fOp
...
@@ -287,33 +226,6 @@ static int vgdrvFreeBSDOpen(struct cdev *pDev, int fOp
 }
...
-/**
  ...
  *
  * @returns depends...
@@ -326,7 +238,11 @@ static int vgdrvFreeBSDIOCtl(struct cdev *pDev, u_long
...
@@ -522,12 +438,14 @@ static int vgdrvFreeBSDPoll(struct cdev *pDev, int fEv
...
@@ -737,18 +652,21 @@ static int vgdrvFreeBSDAttach(device_t pDevice)
...
@@ -792,8 +710,12 @@ static driver_t vgdrvFreeBSDDriver =

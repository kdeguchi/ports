--- src/VBox/Runtime/r0drv/freebsd/mp-r0drv-freebsd.c.orig	2024-10-10 18:32:15 UTC
...
@@ -268,13 +281,14 @@ RTDECL(int) RTMpOnSpecific(RTCPUID idCpu, PFNRTMPWORKE
 #else
...
-#if __FreeBSD_version >= 700000
+#if __FreeBSD_version >= 700000  /* >= 7.0 */
 /**

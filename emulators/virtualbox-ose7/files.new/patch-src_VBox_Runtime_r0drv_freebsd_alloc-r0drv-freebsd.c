--- src/VBox/Runtime/r0drv/freebsd/alloc-r0drv-freebsd.c.orig	2024-10-10 18:32:14 UTC
...
@@ -99,21 +100,26 @@ DECLHIDDEN(int) rtR0MemAllocEx(size_t cb, uint32_t fFl
         pHdr->cbReq      = cb;
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     ...
     /*
@@ -138,6 +144,7 @@ RTR0DECL(void *) RTMemContAlloc(PRTCCPHYS pPhys, size_
         *pPhys = vtophys(pv);
...
@@ -147,7 +154,9 @@ RTR0DECL(void) RTMemContFree(void *pv, size_t cb)
     if (pv)
     {

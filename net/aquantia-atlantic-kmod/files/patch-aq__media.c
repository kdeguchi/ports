...
@@ -94,9 +92,9 @@ void aq_mediastatus_update(aq_dev_t *aq_dev, u32 link_
...
@@ -107,11 +105,11 @@ void aq_mediastatus(struct ifnet *ifp, struct ifmediar

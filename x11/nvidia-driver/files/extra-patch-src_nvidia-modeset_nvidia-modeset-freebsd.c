...
@@ -267,7 +269,7 @@ struct nvkms_ref_ptr {
...
@@ -888,33 +890,31 @@ static int nvkms_poll(
  *************************************************************************/
...
@@ -938,6 +939,7 @@ static void nvkms_linux_compat_unload(void)
 {
 #if defined(NVKMS_SUPPORT_LINUX_COMPAT)
...
@@ -1121,4 +1123,9 @@ MODULE_DEPEND(nvidia_modeset,               /* module 

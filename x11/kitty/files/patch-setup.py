...
+++ setup.py
@@ -253,25 +253,10 @@ def libcrypto_flags() -> Tuple[List[str], List[str]]:
...
@@ -712,6 +697,7 @@ def get_source_specific_defines(env: Env, src: str) ->
...
@@ -1316,8 +1302,8 @@ def create_linux_bundle_gunk(ddir: str, args: Options)
     base = Path(ddir)
